...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   send_to_allocation_bonus.c                         :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: ablidi <ablidi@student.42.fr>              +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/04/08 01:27:23 by ablidi            #+#    #+#             */
/*   Updated: 2023/04/10 20:39:57 by ablidi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	send_to_allocation(t_vars *t)
{
	...
	t->w = mlx_new_window(t->m, t->x_map * 90, t->y_map * 90, "st");
	if (!t->w)
	{
...
void	send_to_allocation2(t_vars *t)
{
	...
	t->fv = mlx_xpm_file_to_image(t->m, "textures/farrev.xpm", &x, &y);
	if (!t->fv)
	{
		destroy_img(t);
		exit (1);
